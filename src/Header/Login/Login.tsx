...
const Login = () => {
  ...
  return (
    <div className="login">
      <button className="login__btn btn-reset" onClick={() => setOpen(true)} type="button">
      <svg className={`login__icon ${open ? 'login__icon-white' : ''}`}
        width="80px"
        height="80px"
        viewBox="0 0 24 24"
        fill="none"
      ...
      <div className={`login__modal ${open ? 'login__modal--active' : ''}`}>
        <div className="login__info">
         
          <button className='login__close btn-reset' onClick={() => setOpen(false)}>
             &#x2715;
          </button>
        </div>
      </div>
